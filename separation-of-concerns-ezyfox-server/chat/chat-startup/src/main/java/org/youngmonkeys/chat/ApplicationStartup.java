package org.youngmonkeys.chat;

import org.youngmonkeys.chat.plugin.PluginEntry;
import org.youngmonkeys.chat.plugin.PluginEntryLoader;
import org.youngmonkeys.chat.app.AppEntry;
import org.youngmonkeys.chat.app.AppEntryLoader;
...
public class ApplicationStartup {
    ...
    public static final String ZONE_APP_NAME = "chat";
        ...
        public EzyPluginEntry load() throws Exception {
            return new PluginEntry() {
                ...
                private String getPluginPath(EzyPluginSetting setting) {
                    Path pluginPath = Paths.get("chat-plugin");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../chat-plugin");
                    }
        ...
        public EzyAppEntry load() throws Exception {
            return new AppEntry() {
                ...
                private String getAppPath() {
                    Path pluginPath = Paths.get("chat-app-entry");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../chat-app-entry");
                    }
                    return pluginPath.toString();
                }
            };
